...
public class Button extends JButton implements MouseListener, MouseMotionListener {
     ...
     */
    public Button(int shape, int orientation) {
     ...
     */
    public Button(int shape, int orientation, Color colorNormal, Color colorHighlighted, Color colorBorderNormal, Color colorBorderHighlighted) {
        super();
